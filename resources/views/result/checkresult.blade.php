            ...
            <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="profile d-flex justify-content-end">
                            ...
                            <a href="{{ route('Adprofile') }}"><img class="img logo my-4  "
                                    style="width: 140px; height:140px;  " {{-- src="{{ (!empty($data->wallpaper_url))? url('backend/wallpaper/'.$data->wallpaper_url):url('img/logoimg.jpg') }}" --}}
                                    src="{{ !empty($Student->Student_image) ? url('profile/' . $Student->Student_image) : url('profile/default.jpeg') }}">
                            </a>
                ...
                <div class="row mt-4">
                    <div class="col-md-6 p-0">
                        ...
                        <p class="d-inline-block" style="font-size: 20px;">{{ $Student->Last_Name }}
                            {{ $Student->First_Name }} {{ $Student->Middle_Name }} </p>
                    </div>
                    <div class="col-md-6">
                        <p class="d-inline-block float-right " style="font-size: 20px;">{{ $yearclass->Student_Year }}
                        </p>
                ...
                <div class="row">
                    <div class="col-md-6 p-0">
                        ...
                        <p class="d-inline-block" style="font-size: 20px;">{{ $Student->ST_ID }} </p>
                    </div>

                    <div class="col-md-6">
                        <p class="d-inline-block float-right " style="font-size: 20px;">{{ $yearclass->Student_Class }}
                        </p>
                ...
                <div class="row">
                    <div class="col-md-6 p-0">
                        ...
                        <p class="d-inline-block" style="font-size: 20px;">{{ $Student->Date_Of_Birth }} </p>
                    </div>
                </div>
