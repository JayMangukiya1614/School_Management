        ...
        <form action="{{ route('updatesave',$SRupdate->id) }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input name="MobileNo" value="{{ $SRupdate->MobileNo }}"
                        class="form-control shadow-lg bg-white rounded-3" type="number">
                </div>

                <div class="col-md-6">
                    <label class="mt-5" for="">Gender</label>
                    <select name="Gender" value="{{ $SRupdate->Gender }}"
                        class="form-control text-center shadow-lg bg-white rounded-3" name="Gender" id="">
                        <option {{$SRupdate->Gender == 'Male' ? 'selected' : ''}} name="Gender" selected value="Male">Male</option>
                        <option {{$SRupdate->Gender == 'Female' ? 'selected' : ''}} name="Gender" value="Feale">Female</option>
                        <option {{$SRupdate->Gender == 'Other' ? 'selected' : ''}} name="Gender" value="Other">Other</option>
                    </select>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input name="Address" value="{{ $SRupdate->Address }}" class="form-control shadow-lg bg-white rounded-3"
                        type="text">
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    ...
                    <select  class="form-control  shadow-lg bg-white rounded-3" name="Class"
                        ...
                        @foreach ($Class as $class)
                            <option {{$SRupdate->Class == $class->Class ? 'selected' : ''}}>{{ $class->Class }}</option>
                        @endforeach
                ...
                <div class="col-md-4">
                    ...
                    <select  class="form-control  shadow-lg bg-white rounded-3" name="Year"
                        ...
                        @foreach ($Year as $year)
                            <option {{$SRupdate->Year == $year->Year ? 'selected' : ''}} >{{ $year->Year }}</option>
                        @endforeach
                ...
                <div class="col-md-4">
                    ...
                    <input name="E_mail" value="{{ $SRupdate->E_mail }}"
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input name="Religion" value="{{ $SRupdate->Religion }}"
                        class="form-control shadow-lg bg-white rounded-3" type="text">
                </div>
                <div class="col-md-4">
                    <label class="mt-5" for="D.O.B">D.O.B</label>
                    <input name="Date_Of_Birth" value="{{ $SRupdate->Date_Of_Birth }}"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <button type="submit"
                        class="btn btn-outline-success form-control shadow-lg  rounded-3 mt-5">Update</button>
